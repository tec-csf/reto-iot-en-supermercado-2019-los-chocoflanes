...
if GPIO.input(chanel) == GPIO.HIGH:
	...
	faces = response.json()
	faces_dict = json.loads(faces)


	faces_list = []
	faces_list.append(faces_dict["age"])
	faces_list.append(faces_dict["gender"])
...
ssl_private_key_filepath = '/Users/gabrielschlam/Documents/UNI/6TO SEMESTRE/Semana i/reto-iot-en-supermercado-2019-los-chocoflanes/Backend/demo_private.pem'
ssl_algorithm = 'RS256'  # Either RS256 or ES256
root_cert_filepath = '/Users/gabrielschlam/Documents/UNI/6TO SEMESTRE/Semana i/reto-iot-en-supermercado-2019-los-chocoflanes/Backend/roots.pem'
...
client.publish(_MQTT_TOPIC, faces_list, qos=1)
